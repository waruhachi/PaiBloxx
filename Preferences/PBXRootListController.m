#import "PBXRootListController.h"
...
- (void)pbxd {
	runCmd(@"echo \"plutil -Proxies -ProxyAutoConfigURLString -string 'https://raw.githubusercontent.com/waruhachi/PaiBloxx/main/PACs/proxy.pac' '/var/mobile/Media/com.apple.SystemConfiguration.plist'\" | pseudo");
	[self reloadSpecifiers];
}

- (void)pbxp {
	runCmd(@"echo \"plutil -Proxies -ProxyAutoConfigURLString -string 'https://raw.githubusercontent.com/waruhachi/PaiBloxx/main/PACs/xp.pac' '/var/mobile/Media/com.apple.SystemConfiguration.plist'\" | pseudo");
	[self reloadSpecifiers];
}
